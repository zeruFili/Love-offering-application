...
class _YouTubeVideoPageState extends State<YouTubeVideoPage> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => YoutubePlayerScreen(
          ...
          video: video,
          onGiftPressed: () => _handleGiftButtonTap(video),
        ),
      ),
    );
  }

  // Modified method to handle gift button with authentication check
  void _handleGiftButtonTap(YouTubeVideo video) async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => DepositPage(videoId: videoId),
      ),
    );
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          const Spacer(),
                          // Gift Button with Authentication Check
                          GestureDetector(
